...
describe('Object API', () => {
  ...
  describe('Generate urls', () => {
    test('get public URL', async () => {
      ...
      expect(res.publicURL).toEqual(`${URL}/object/public/${bucketName}/${uploadPath}`)
    })
    ...
    test('sign url', async () => {
      ...
      expect(res.error).toBeNull()
      expect(res.signedURL).toContain(`${URL}/object/sign/${bucketName}/${uploadPath}`)
    })
  })
  ...
  describe('Upload files', () => {
    test('uploading using form-data', async () => {
      ...
      expect(res.error).toBeNull()
      expect(res.data?.Key).toEqual(`${bucketName}/${uploadPath}`)
    })
    ...
    test('upload and update file', async () => {
      ...
      expect(updateRes.data?.Key).toEqual(`${bucketName}/${uploadPath}`)
    })
  })
